...
import org.tcheum.jsontestsuite.suite.StateTestSuite;
import org.tcheum.jsontestsuite.suite.runners.StateTestRunner;
...
import static org.tcheum.solidity.SolidityType.*;
...
public class TransactionTest {
    ...
    // Testdata from: https://github.com/tcheum/tests/blob/master/txtest.json
...
//        Transaction tx = new Transaction(Hex.decode(rlp));
        ...
        */
        ...
        List<String> res = new StateTestRunner(stateTestSuite.getTestCases().get("test1")) {
            ...
            protected ProgramResult executeTransaction(Transaction tx) {
                // first emulating the constant call (tcheum.callConstantFunction)
    ...
    public void homesteadContractCreationTest() throws Exception {
        ...
        // https://github.com/tcheum/EIPs/blob/master/EIPS/eip-2.mediawiki
