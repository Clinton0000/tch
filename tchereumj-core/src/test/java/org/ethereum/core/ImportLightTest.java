...
public class ImportLightTest {
    ...
    public void importBlocks() throws Exception {
        ...
        Scanner scanner = new Scanner(new FileInputStream("D:\\ws\\tcheumj\\work\\blocks-rec.dmp"));
    ...
    public void simpleRebranch() {
        ...
        sb.sendtch(addr1.getAddress(), BigInteger.valueOf(100));
        Block b1 = sb.createBlock();
        sb.sendtch(addr1.getAddress(), BigInteger.valueOf(100));
        ...
        sb.sendtch(addr1.getAddress(), BigInteger.valueOf(200));
...
//        Assert.assertEquals(bal2, bal2_);
    ...
    public void createValueTest() throws IOException, InterruptedException {
        ...
        bc.sendtch(a.getAddress(), BigInteger.valueOf(10_000));
    ...
    public void spendGasSimpleTest() throws IOException, InterruptedException {
        ...
        bc.sendtch(new byte[20], BigInteger.ZERO);
        bc.createBlock();
...
//                    bc.getPendingState().addPendingTransaction(callTx);
        ...
        while(cnt++ > 0) {
            ...
            bc.sendtch(new byte[32], BigInteger.ONE);
...
//        System.out.println(Hex.toHexString(b2_.getHash()));
    ...
    public void suicideInFailedCall() throws Exception {
        ...
        bc.addtcheumListener(new tcheumListenerAdapter() {
            @Override
    ...
    public static BlockchainImpl createBlockchain(Genesis genesis) {
        ...
        tcheumListenerAdapter listener = new tcheumListenerAdapter();
