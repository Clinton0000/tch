...
public class StandaloneBlockchainTest {
    ...
    public void invalidTxTest() {
        ...
        ECKey bob = new ECKey();
        sb.sendtch(bob.getAddress(), BigInteger.valueOf(1000));
        sb.setSender(bob);
        sb.sendtch(alice.getAddress(), BigInteger.ONE);
        sb.setSender(alice);
        sb.sendtch(bob.getAddress(), BigInteger.valueOf(2000));
    ...
    public void initBalanceTest() {
        ...
        ECKey alice = sb.getSender();
        ECKey bob = new ECKey();
        sb.withAccountBalance(bob.getAddress(), convert(123, tch));
        ...
        assert convert(123, tch).equals(bobInitBal);
        ...
        assert convert(123, tch).compareTo(sb.getBlockchain().getRepository().getBalance(bob.getAddress())) > 0;
