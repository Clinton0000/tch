...
import static org.tcheum.util.ByteUtil.byteArrayToInt;
import static org.tcheum.util.ByteUtil.wrap;
import static org.tcheum.util.RLP.*;
import static org.junit.Assert.*;
import static org.tcheum.util.RlpTestData.*;
...
public class RLPTest {
    ...
    public void test7() {
        ...
        String test = "tcheumJ Client";
        data = encodeString(test);

        assertArrayEquals(expected, data);

        String test2 = "tcheum(++)/ZeroGox/v0.5.0/ncurses/Linux/g++";
        ...
        String test3 = "tcheum(++)/ZeroGox/v0.5.0/ncurses/Linux/g++tcheum(++)/ZeroGox/v0.5.0/ncurses/Linux/g++";
...
//        2240089100000070
    ...
    /************************************
     * Test data from: https://github.com/tcheum/wiki/wiki/%5BEnglish%5D-RLP
     *
