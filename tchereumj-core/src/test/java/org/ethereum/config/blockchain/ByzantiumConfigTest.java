...
public class ByzantiumConfigTest {
    ...
    @Test
    @Ignore
    public void testtchscanIoBlock4490790() throws Exception {
        ByzantiumConfig byzantiumConfig = new ByzantiumConfig(new TestBlockchainConfig());

        // https://tchscan.io/block/4490788
        ...
        // https://tchscan.io/block/4490789
        ...
        BigInteger actualDifficultyOntchscan = BlockHeaderBuilder.parse("1,377,927,933,620,791");
        assertTrue(actualDifficultyOntchscan.compareTo(minimumDifficulty) > -1);
    }
