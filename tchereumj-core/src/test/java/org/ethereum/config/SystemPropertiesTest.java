...
public class SystemPropertiesTest {
    ...
    public void testRequireEitherNameOrClassConfiguration() {
        try {
            SystemProperties props = new SystemProperties();
            props.overrideParams("blockchain.config.name", "test", "blockchain.config.class", "org.tcheum.config.net.TestNetConfig");
            props.getBlockchainConfig();
    ...
    public void testRequireTypeBlockchainNetConfigOnManualClass() {
        SystemProperties props = new SystemProperties();
        props.overrideParams("blockchain.config.name", null, "blockchain.config.class", "org.tcheum.config.net.TestNetConfig");
    ...
    public void testNonExistentBlockchainNetConfigClass() {
        SystemProperties props = new SystemProperties();
        try {
            props.overrideParams("blockchain.config.name", null, "blockchain.config.class", "org.tcheum.config.net.NotExistsConfig");
            props.getBlockchainConfig();
            fail("Should throw exception for invalid class");
        } catch (RuntimeException expected) {
            assertEquals("The class specified via blockchain.config.class 'org.tcheum.config.net.NotExistsConfig' not found", expected.getMessage());
        }
    }
    ...
    public void testNotInstanceOfBlockchainForkConfig() {
        ...
        try {
            props.overrideParams("blockchain.config.name", null, "blockchain.config.class", "org.tcheum.config.NodeFilter");
            props.getBlockchainConfig();
            fail("Should throw exception for invalid class");
        } catch (RuntimeException expected) {
            assertEquals("The class specified via blockchain.config.class 'org.tcheum.config.NodeFilter' is not instance of org.tcheum.config.BlockchainForkConfig", expected.getMessage());
        }
    }
