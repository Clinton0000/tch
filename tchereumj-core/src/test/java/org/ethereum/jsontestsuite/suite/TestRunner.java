...
import org.tcheum.jsontestsuite.suite.model.BlockTck;
import org.tcheum.jsontestsuite.suite.validators.BlockHeaderValidator;
...
import org.tcheum.validator.DependentBlockHeaderRuleAdapter;
import org.tcheum.vm.DataWord;
import org.tcheum.vm.LogInfo;
import org.tcheum.vm.VM;
import org.tcheum.vm.program.Program;
import org.tcheum.vm.program.invoke.ProgramInvoke;
import org.tcheum.vm.program.invoke.ProgramInvokeFactoryImpl;
import org.tcheum.vm.program.invoke.ProgramInvokeImpl;
import org.tcheum.vm.trace.ProgramTrace;
...
import static org.tcheum.crypto.HashUtil.shortHash;
import static org.tcheum.util.ByteUtil.EMPTY_BYTE_ARRAY;
import static org.tcheum.vm.VMUtils.saveProgramTraceFile;
...
public class TestRunner {
    ...
    public List<String> runTestCase(BlockTestCase testCase) {
        ...
        PendingStateImpl pendingState = new PendingStateImpl(new tcheumListenerAdapter());
    ...
    public List<String> runTestCase(TestCase testCase) {
        ...
        try {
            ...
            if (testCase.getPost() == null) {
                ...
                List<org.tcheum.vm.CallCreate> resultCallCreates =
                        program.getResult().getCallCreateList();

                // assert call creates
                for (int i = 0; i < testCase.getCallCreateList().size(); ++i) {

                    org.tcheum.vm.CallCreate resultCallCreate = null;
...
//          repository.close();
    ...
    public org.tcheum.core.Transaction createTransaction(Transaction tx) {
        ...
        org.tcheum.core.Transaction transaction = new org.tcheum.core.Transaction(
