...
/*
    ...
    @Test */
/* Tests whtch a message can be wrapped without any identity or encryption. *//*
    ...
    @Test */
/* Tests whtch a message can be signed, and wrapped in plain-text. *//*
    ...
    @Test */
/* Tests whtch a message can be encrypted and decrypted using an anonymous sender (i.e. no signature).*//*
    ...
    @Test */
/* Tests whtch a message can be properly signed and encrypted. *//*
