...
//        remoteJsonRpc = new URL("http://whisper-1.tch.camp:8545");
...
//                "@whisper-1.tch.camp:30303");
        ...
        tcheum tcheum = tcheumFactory.createtcheum(Config.class);
        tcheum.connect(
                node.getHost(),
                node.getPort(),
    ...
    public static class TestComponent extends Thread {
        ...
        void init() {
            ...
            worldManager.addListener(new tcheumListenerAdapter() {
                @Override
