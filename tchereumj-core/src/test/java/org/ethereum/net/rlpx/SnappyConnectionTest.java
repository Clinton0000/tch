...
public class SnappyConnectionTest {
    ...
    private void runScenario(int vOutbound, int vInbound) throws FileNotFoundException, InterruptedException {
        ...
        tcheum tcheum1 = tcheumFactory.createtcheum(SysPropConfig1.class);
        tcheum tcheum2 = tcheumFactory.createtcheum(SysPropConfig2.class);
        ...
        tcheum2.connect(new Node("enode://a560c55a0a5b5d137c638eb6973812f431974e4398c6644fa0c19181954fab530bb2a1e2c4eec7cc855f6bab9193ea41d6cf0bf2b8b41ed6b8b9e09c072a1e5a" +
                "@localhost:30334"));
