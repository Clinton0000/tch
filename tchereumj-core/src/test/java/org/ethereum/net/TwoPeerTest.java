...
//        });
    ...
    public void testTest() throws FileNotFoundException, InterruptedException {
        ...
        BlockchainImpl blockchain = (BlockchainImpl) tcheum1.getBlockchain();
...
//        byte[] root = ((RepositoryImpl) tcheum.getRepository()).getRoot();
//        ((RepositoryImpl) tcheum.getRepository()).syncToRoot(root);
//        byte[] root1 = ((RepositoryImpl) tcheum.getRepository()).getRoot();
