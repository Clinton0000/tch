...
import org.tcheum.ConcatKDFBytesGenerator;
...
public class ECIESTest {
    ...
    public static byte[] decrypt(BigInteger prv, byte[] cipher) throws InvalidCipherTextException, IOException {
        ...
        tcheumIESEngine iesEngine = makeIESEngine(false, ephem, prv, IV);
    ...
    public static byte[] encrypt(ECPoint toPub, byte[] plaintext) throws InvalidCipherTextException, IOException {
        ...
        tcheumIESEngine iesEngine = makeIESEngine(true, toPub, prv, IV);
    ...
    private static tcheumIESEngine makeIESEngine(boolean isEncrypt, ECPoint pub, BigInteger prv, byte[] IV) {
        AESEngine aesFastEngine = new AESEngine();

        tcheumIESEngine iesEngine = new tcheumIESEngine(
