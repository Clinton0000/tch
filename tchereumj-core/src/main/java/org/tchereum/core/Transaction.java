...
import static org.tcheum.util.ByteUtil.ZERO_BYTE_ARRAY;
...
import org.tcheum.crypto.ECKey.ECDSASignature;
import org.tcheum.crypto.ECKey.MissingPrivateKeyException;
import org.tcheum.crypto.HashUtil;
import org.tcheum.datasource.MemSizeEstimator;
 ...
 * signed instruction sent by an actor external to tcheum.
...
public class Transaction {
    ...
    /* the amount of tch to transfer (calculated as wei) */
    private byte[] value;
    ...
    /* the amount of tch to pay as a transaction fee
