...
import static org.tcheum.listener.tcheumListener.PendingTransactionState.DROPPED;
import static org.tcheum.listener.tcheumListener.PendingTransactionState.INCLUDED;
import static org.tcheum.listener.tcheumListener.PendingTransactionState.NEW_PENDING;
import static org.tcheum.listener.tcheumListener.PendingTransactionState.PENDING;
...
//    private Repository repository;
    ...
    @Autowired
    public PendingStateImpl(final tcheumListener listener) {
...
//        this.repository = blockchain.getRepository();
    ...
    private TransactionReceipt executeTx(Transaction tx) {
        ...
        TransactionExecutor executor = new TransactionExecutor(
                ...
                blockStore, programInvokeFactory, createFakePendingBlock(), new tcheumListenerAdapter(), 0)
