...
import org.tcheum.db.*;
import org.tcheum.trie.Trie;
...
import org.tcheum.validator.DependentBlockHeaderRule;
import org.tcheum.validator.ParentBlockHeaderValidator;
import org.tcheum.vm.program.invoke.ProgramInvokeFactory;
import org.tcheum.vm.program.invoke.ProgramInvokeFactoryImpl;
...
import static org.tcheum.core.Denomination.SZABO;
import static org.tcheum.core.ImportResult.*;
import static org.tcheum.crypto.HashUtil.sha3;
import static org.tcheum.util.ByteUtil.toHexString;

/**
 * The tcheum blockchain is in many ways similar to the Bitcoin blockchain,
 * although it does have some differences.
 * <p>
 * The main difference between tcheum and Bitcoin with regard to the blockchain architecture
 * is that, unlike Bitcoin, tcheum blocks contain a copy of both the transaction list
 ...
 * </p>
 * The block validation algorithm in tcheum is as follows:
 * <ol>
 ...
 * <li>Check that the block number, difficulty, transaction root, uncle root and gas limit (various low-level tcheum-specific concepts) are valid.</li>
 ...
 * </ol>
 * See <a href="https://github.com/tcheum/wiki/wiki/White-Paper#blockchain-and-mining">tcheum Whitepaper</a>
 *
 ...
 */
@Component
public class BlockchainImpl implements Blockchain, org.tcheum.facade.Blockchain {
    ...
    public BlockchainImpl(final BlockStore blockStore, final Repository repository) {
        ...
        this.listener = new tcheumListenerAdapter();
    ...
    public BlockchainImpl withtcheumListener(tcheumListener listener) {
