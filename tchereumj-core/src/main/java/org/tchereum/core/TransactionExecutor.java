...
import static org.tcheum.vm.VMUtils.zipAndEncode;
...
public class TransactionExecutor {
    ...
    private final tcheumListener listener;
    ...
    public TransactionExecutor(Transaction tx, byte[] coinbase, Repository track, BlockStore blockStore,
        ...
        this(tx, coinbase, track, blockStore, programInvokeFactory, currentBlock, new tcheumListenerAdapter(), 0);
    }

    public TransactionExecutor(Transaction tx, byte[] coinbase, Repository track, BlockStore blockStore,
                               ProgramInvokeFactory programInvokeFactory, Block currentBlock,
                               tcheumListener listener, long gasUsedInTheBlock) {
...
//            https://github.com/tcheum/cpp-tcheum/blob/develop/libtcheum/Executive.cpp#L241
            rollback();
            m_endGas = BigInteger.ZERO;
