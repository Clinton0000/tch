...
import static org.tcheum.util.BIUtil.max;

/**
 * tcheum Classic HF on Block #3_000_000:
 * - EXP reprice (EIP-160)
 * - Replay Protection (EIP-155) (chainID: 61)
 * - Difficulty Bomb delay (ECIP-1010) (https://github.com/tcheumproject/ECIPs/blob/master/ECIPs/ECIP-1010.md)
 *
