...
import org.tcheum.datasource.leveldb.LevelDbDataSource;
...
import org.tcheum.sync.FastSyncManager;
import org.tcheum.validator.*;
import org.tcheum.vm.DataWord;
import org.tcheum.vm.program.ProgramPrecompile;
...
public class CommonConfig {
    ...
    public void fastSyncCleanUp() {
        ...
        tcheumListener.SyncState syncStage = tcheumListener.SyncState.values()[fastsyncStageBytes[0]];

        if (!systemProperties().isFastSyncEnabled() || syncStage == tcheumListener.SyncState.UNSECURE) {
