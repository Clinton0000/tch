 ...
 * RLP is the main encoding method used to serialize objects in tcheum. The
 ...
 * tcheum the standard is that integers are represented in big endian binary
 ...
 * <p>
 * See: https://github.com/tcheum/wiki/wiki/%5BEnglish%5D-RLP
 *
...
public class RLP {
    ...
    public static int decodeInt(byte[] data, int index) {
        ...
        int value = 0;
        // NOTE: From RLP doc:
        // tcheum integers must be represented in big endian binary form
