...
import org.tcheum.solidity.compiler.CompilationResult.ContractMetadata;
...
//        }
    ...
    @Override
    public void sendtch(byte[] toAddress, BigInteger weis) {
    ...
    public BlockchainImpl getBlockchain() {
        if (blockchain == null) {
            ...
            addtcheumListener(new tcheumListenerAdapter() {
                @Override
    ...
    public void addtcheumListener(tcheumListener listener) {
        getBlockchain();
    ...
    private BlockchainImpl createBlockchain(Genesis genesis) {
        ...
        listener = new CompositetcheumListener();

        BlockchainImpl blockchain = new BlockchainImpl(blockStore, repository)
                .withtcheumListener(listener)
