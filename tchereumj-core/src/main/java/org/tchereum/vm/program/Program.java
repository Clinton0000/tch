...
import org.tcheum.util.ByteArraySet;
import org.tcheum.util.ByteUtil;
import org.tcheum.util.FastByteComparisons;
import org.tcheum.util.Utils;
import org.tcheum.vm.*;
import org.tcheum.vm.PrecompiledContracts.PrecompiledContract;
...
import org.tcheum.vm.program.listener.CompositeProgramListener;
import org.tcheum.vm.program.listener.ProgramListenerAware;
import org.tcheum.vm.program.listener.ProgramStorageChangeListener;
import org.tcheum.vm.trace.ProgramTraceListener;
...
import static org.tcheum.util.BIUtil.*;
...
public class Program {
     ...
     * tcheumj may need to be started with a JVM argument to increase
    ...
    /**
     * Denotes problem when executing tcheum bytecode.
