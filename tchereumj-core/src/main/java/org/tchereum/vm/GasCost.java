...
/**
 * The fundamental network cost unit. Paid for exclusively by tch, which is converted
 * freely to and from Gas as required. Gas does not exist outside of the internal tcheum
