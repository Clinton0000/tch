...
import org.tcheum.crypto.jce.ECKeyAgreement;
import org.tcheum.crypto.jce.ECKeyFactory;
import org.tcheum.crypto.jce.ECKeyPairGenerator;
import org.tcheum.crypto.jce.ECSignatureFactory;
import org.tcheum.crypto.jce.SpongyCastleProvider;
...
import static org.tcheum.util.BIUtil.isLessThan;
import static org.tcheum.util.ByteUtil.bigIntegerToBytes;
 ...
 *
 * This code is borrowed from the bitcoinj project and altered to fit tcheum.<br>
...
public class ECKey implements Serializable {
    ...
    /**
     * The parameters of the secp256k1 curve that tcheum uses.
     */
    ...
    static {
        // All clients must agree on the curve to use by agreement. tcheum uses secp256k1.
    ...
    /**
     * Returns whtch this key is using the compressed form or not. Compressed pubkeys are only 33 bytes, not 64.
     *
     *
     * @return  -
     */
     ...
     * how ECDSA signatures are represented when embedded in other data structures in the tcheum protocol. The raw
    ...
    public static class ECDSASignature {
         ...
         * the same message. However, we dislike the ability to modify the bits of a tcheum transaction after it's
     ...
     * @param signatureBase64 The tcheum-format message signature in base64
     *
     * @return -
