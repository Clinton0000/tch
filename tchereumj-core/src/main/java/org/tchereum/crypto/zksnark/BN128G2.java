 ...
 */
package org.tcheum.crypto.zksnark;

import java.math.BigInteger;

import static org.tcheum.crypto.zksnark.Params.R;
import static org.tcheum.crypto.zksnark.Params.TWIST_MUL_BY_P_X;
import static org.tcheum.crypto.zksnark.Params.TWIST_MUL_BY_P_Y;
...
public class BN128G2 extends BN128Fp2 {
    ...
    /**
     * Checks whtch provided data are coordinates of a point belonging to subgroup,
    ...
    public static BN128G2 create(byte[] a, byte[] b, byte[] c, byte[] d) {
        ...
        // check whtch point is a subgroup member
