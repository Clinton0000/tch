 ...
 *
 * As a side effect this sample shows how Java wrappers for tcheum contracts can be
...
public class PriceFeedSample extends BasicSample {
    ...
    /**
     * Base class for a tcheum Contract wrapper
    ...
    abstract class tcheumContract {
         ...
         */
        protected tcheumContract(String contractAddr) {
         ...
         *  by their names only
         */
        public tcheumContract(String contractAddr, String contractABI) {
            this.contractAddr = contractAddr;
        ...
        protected Object[] callFunction(String name, String[] inParamTypes, String[] outParamTypes, Object ... args) {
            ...
            ProgramResult result = tcheum.callConstantFunction(contractAddr, function, args);
        ...
        public boolean isExist() {
            return !contractAddr.equals(zeroAddr) && tcheum.getRepository().isExist(Hex.decode(contractAddr));
        }
    }
     ...
     * https://live.tch.camp/account/985509582b2c38010bfaa3c8d2be60022d3d00da
     */
    class NameRegContract extends tcheumContract {
     ...
     *
     * Contract sources, live state and many more here:
     * https://live.tch.camp/account/1194e966965418c7d73a42cceeb254d875860356
     */
    class PriceFeedContract extends tcheumContract {
...
//            worker();
    ...
    private void worker() throws Exception{
        ...
        String priceFeedAddress = Hex.toHexString(nameRegContract.addressOf("tch-camp/price-feed"));
