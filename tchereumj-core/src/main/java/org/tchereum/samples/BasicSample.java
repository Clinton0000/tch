...
/**
 *  The base sample class which creates tcheumJ instance, tracks and report all the stages
 ...
 *  all components created within tcheumJ. However almost all this could be done without dealing
...
//                throw new RuntimeException("Sync peers failed.");
    ...
    protected void waitForFirstBlock() throws Exception {
        Block currentBest = tcheum.getBlockchain().getBestBlock();
