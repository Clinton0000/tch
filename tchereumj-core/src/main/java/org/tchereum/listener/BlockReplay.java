 ...
 *
 * All other tcheumListener events are just forwarded to the supplied listener.
 *
 * For example of usage, look at {@link org.tcheum.samples.EventListenerSample}
 *
 * Created by Anton Nashatyrev on 18.07.2016.
 */
public class BlockReplay extends tcheumListenerAdapter {
    ...
    public BlockReplay(BlockStore blockStore, TransactionStore transactionStore, tcheumListener listener, long firstBlock) {
