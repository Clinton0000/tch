...
import org.tcheum.db.migrate.MigrateHeaderSourceTotalDiff;
...
import org.tcheum.net.rlpx.discover.UDPListener;
...
import static org.tcheum.crypto.HashUtil.EMPTY_TRIE_HASH;
...
public class WorldManager {
    ...
    public WorldManager(final SystemProperties config, final Repository repository,
                        final tcheumListener listener, final Blockchain blockchain,
    ...
    public void addListener(tcheumListener listener) {
        logger.info("tcheum listener added");
        ((CompositetcheumListener) this.listener).addListener(listener);
    }
    ...
    public tcheumListener getListener() {
        return listener;
    }

    public org.tcheum.facade.Repository getRepository() {
        return (org.tcheum.facade.Repository)repository;
    }
