...
public interface tcheum {
    ...
    void addListener(tcheumListener listener);
     ...
     * @param value - the tch value of the transaction
     ...
     * and decoded with {@link org.tcheum.core.CallTransaction.Function#decodeResult(byte[])}.
     */
...
//  2.   // is blockchain still loading - if buffer is not empty
     ...
     * like tcheum MainNet. But it's light and simple and still could be used for test networks. If you
     * want to get accurate recommended gas price use {@link org.tcheum.listener.RecommendedGasPriceTracker}
     ...
     * @return Future, which completes when syncDone is turned to True in {@link org.tcheum.sync.SyncManager}
     */
