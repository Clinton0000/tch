...
import org.tcheum.net.server.tcheumChannelInitializer;
...
public class PeerClient {
    ...
    public ChannelFuture connectAsync(String host, int port, String remoteId, boolean discoveryMode) {
        tcheumListener.trace("Connecting to: " + host + ":" + port);

        tcheumChannelInitializer tcheumChannelInitializer = ctx.getBean(tcheumChannelInitializer.class, remoteId);
        tcheumChannelInitializer.setPeerDiscoveryMode(discoveryMode);
        ...
        b.handler(tcheumChannelInitializer);
