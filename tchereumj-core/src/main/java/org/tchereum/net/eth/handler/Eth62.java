...
import org.tcheum.net.eth.message.*;
import org.tcheum.net.message.ReasonCode;
import org.tcheum.net.rlpx.discover.NodeManager;
...
import org.tcheum.sync.PeerState;
import org.tcheum.sync.SyncStatistics;
import org.tcheum.util.ByteUtil;
import org.tcheum.validator.BlockHeaderRule;
...
import static org.tcheum.datasource.MemSizeEstimator.ByteArrayEstimator;
import static org.tcheum.net.eth.EthVersion.V62;
import static org.tcheum.net.message.ReasonCode.USELESS_PEER;
import static org.tcheum.sync.PeerState.*;
import static org.tcheum.sync.PeerState.BLOCK_RETRIEVING;
import static org.tcheum.util.Utils.longToTimePeriod;
...
public class Eth62 extends EthHandler {
    ...
    public Eth62(final SystemProperties config, final Blockchain blockchain,
                 final BlockStore blockStore, final CompositetcheumListener tcheumListener) {
        this(version, config, blockchain, blockStore, tcheumListener);
    }

    Eth62(final EthVersion version, final SystemProperties config,
          final Blockchain blockchain, final BlockStore blockStore,
          final CompositetcheumListener tcheumListener) {
        super(version, config, blockchain, blockStore, tcheumListener);
    }
    ...
    protected synchronized void processStatus(StatusMessage msg, ChannelHandlerContext ctx) throws InterruptedException {
        ...
        try {
            ...
            tcheumListener.onEthStatusUpdated(channel, msg);
