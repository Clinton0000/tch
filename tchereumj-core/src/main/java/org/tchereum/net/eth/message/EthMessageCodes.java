...
/**
 * A list of commands for the tcheum network protocol.
 * <br>
 * The codes for these commands are the first byte in every packet.
 *
 * @see <a href="https://github.com/tcheum/wiki/wiki/tcheum-Wire-Protocol">
 * https://github.com/tcheum/wiki/wiki/tcheum-Wire-Protocol</a>
 */
public enum EthMessageCodes {
     ...
     *
     * Inform a peer of it's current tcheum state. This message should be
     * send after the initial handshake and prior to any tcheum related messages.
     */
    STATUS(0x00),
     ...
     * are transactions in the format described in the main tcheum specification.
     */
    TRANSACTIONS(0x02),
     ...
     * block headers in the format described in the main tcheum specification,
     ...
     * in the format described in the main tcheum specification, previously asked for in a GetBlockBodies message.
     * This may validly contain no block headers
     * if no block headers were able to be returned for the GetBlockHeaders query.
     */
    BLOCK_BODIES(0x06),
     ...
     * in the main tcheum specification.
     */
    NEW_BLOCK(0x07),
