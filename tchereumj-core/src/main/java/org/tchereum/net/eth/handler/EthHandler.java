...
public abstract class EthHandler extends SimpleChannelInboundHandler<EthMessage> implements Eth {
    ...
    protected CompositetcheumListener tcheumListener;
    ...
    protected tcheumListener listener = new tcheumListenerAdapter() {
        @Override
    ...
    protected EthHandler(final EthVersion version, final SystemProperties config,
        ...
        this.tcheumListener.addListener(listener);
    ...
    public void channelRead0(final ChannelHandlerContext ctx, EthMessage msg) throws InterruptedException {
        ...
        tcheumListener.trace(String.format("EthHandler invoke: [%s]", msg.getCommand()));
    ...
    public void handlerRemoved(ChannelHandlerContext ctx) throws Exception {
        ...
        tcheumListener.removeListener(listener);
        onShutdown();
    }

    public void activate() {
        logger.debug("ETH protocol activated");
        tcheumListener.trace("ETH protocol activated");
        sendStatus();
    }
