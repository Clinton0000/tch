...
import static org.tcheum.net.message.ReasonCode.REQUESTED;
import static org.tcheum.net.message.ReasonCode.UNKNOWN;
import static org.tcheum.net.p2p.P2pMessageCodes.DISCONNECT;

/**
 * Wrapper around an tcheum Disconnect message on the network
 *
 * @see org.tcheum.net.p2p.P2pMessageCodes#DISCONNECT
 */
