...
import org.tcheum.net.client.ConfigCapabilities;
...
import org.tcheum.net.swarm.Util;
...
import static org.tcheum.net.message.StaticMessages.*;
...
public class P2pHandler extends SimpleChannelInboundHandler<P2pMessage> {
    ...
    public void handlerAdded(ChannelHandlerContext ctx) throws Exception {
        ...
        tcheumListener.trace("P2P protocol activated");
        startTimers();
    }
    ...
    public void channelRead0(final ChannelHandlerContext ctx, P2pMessage msg) throws InterruptedException {
        ...
        tcheumListener.trace(String.format("P2PHandler invoke: [%s]", msg.getCommand()));
...
//                sendGetPeers();
    ...
    public void setHandshake(HelloMessage msg, ChannelHandlerContext ctx) {
        ...
        tcheumListener.onHandShakePeer(channel, msg);
    }
