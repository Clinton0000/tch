...
import org.tcheum.config.NodeFilter;
...
import static org.tcheum.net.message.ReasonCode.DUPLICATE_PEER;
import static org.tcheum.net.message.ReasonCode.TOO_MANY_PEERS;
...
public class ChannelManager {
    ...
    /**
     * Whtch peer with the same ip is in newPeers, waiting for processing
    ...
    /**
     * Checks whtch newPeers is not full
