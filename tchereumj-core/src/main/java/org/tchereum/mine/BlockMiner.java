...
import org.tcheum.mine.MinerIfc.MiningResult;
...
public class BlockMiner {
    ...
    private CompositetcheumListener listener;
    ...
    @Autowired
    public BlockMiner(final SystemProperties config, final CompositetcheumListener listener,
    ...
    protected void blockMined(Block newBlock) throws InterruptedException {
        ...
        ImportResult importResult = ((tcheumImpl) tcheum).addNewMinedBlock(newBlock);
